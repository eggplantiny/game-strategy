import { AllBetrayer, AllCooperator, TFT, Random, Joss, FriedMan, TF2T, TFTWO } from "../src/strategy";
...
describe('Super Multiple Game', () => {
    ...
    const friedMan = new FriedMan()
    const tf2t = new TF2T()
    const tftwo = new TFTWO()

    const size = 10

    const playerInfoList = [
        { name: 'ALL C', color: '#FFFFFF', strategy: allC },
        ...
        { name: 'TFTWO', color: '#123123', strategy: tftwo }
    ]
